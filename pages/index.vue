...
<nav class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#q6">Question6</a></li>
        <li><a href="#q7">Question7</a></li>
        <li><a href="#q8">Question8</a></li>
...
<div class="fluid1">
  <h3>Question 1</h3>
  <h4>"Rank your 5 favorite, and least favorite, activities from this list:" <a href="https://gist.github.com/fool/b0f254ff8c72a5765b6a9138249789d6"></a></h4> 
</div>
...
<div class="jumbotron">
  <h3>Answer 5</h3> 
  <p>I had a great time working on this assesment, and working on netlify. Everything was just done easily and it worked great with time! I can only suggest to limit this assesment with time, because otherwise I found myself continuously trying to improve the web page and explore more static generators.</p> 
</div>
...
<div class="jumbotron">
  ...
  <li>6) Perform a traceroute on the website. Use this link:<a href="https://support.cloudflare.com/hc/en-us/articles/200169336-How-do-I-run-a-traceroute-"></a> to conduct an effective traceroute.</li>
